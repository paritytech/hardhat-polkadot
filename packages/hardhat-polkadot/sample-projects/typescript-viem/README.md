...
This project demonstrates how to use Hardhat v3 with Polkadot and Viem. It comes with a sample contract, a test for that contract, and a Hardhat Ignition module that deploys that contract.
