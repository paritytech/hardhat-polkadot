...
- Bumped `@parity/hardhat-polkadot-resolc` to `0.2.3`.


## 0.2.6 (2026-01-06)
### Internal

- Bumped `@parity/hardhat-polkadot-node` to `0.2.5`.


## 0.2.5 (2025-12-10)
### Internal

- Bumped `@parity/hardhat-polkadot-resolc` to `0.2.2`.
...
- Bumped `@parity/hardhat-polkadot-node` to `0.2.0`.
- Bumped `@parity/hardhat-polkadot-resolc` to `0.2.0`.
- Bumped `@parity/hardhat-polkadot-migrator` to `0.1.0`.

## 0.2.0-pre5 (2025-11-06)
### Internal

- Bumped `@parity/hardhat-polkadot-node` to `0.2.0-pre4`.
