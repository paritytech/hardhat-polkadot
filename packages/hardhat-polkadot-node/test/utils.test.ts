...
// Mock the barrel to break the circular dependency chain
...
describe("constructCommandArgs", () => {
    ...
    it("configures consensus for non-manual seal modes", () => {
        ...
        expect(result.nodeCommands).toContain("--consensus=instant")
    })
    ...
    it("configures consensus with default None seal", () => {
        ...
        expect(result.nodeCommands).toContain("--consensus=none")
    })
    ...
    it("does not add consensus when no nodeBinaryPath", () => {
        ...
        expect(result.nodeCommands).not.toContain("--consensus=instant")
    })
})
